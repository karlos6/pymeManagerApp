...
import 'package:pymemanager/ui/pages/customers/controllerCustomers.dart';
...
class _CustomersListState extends State<CustomersList> {
  List<CustomersRequest> listaCategorias = [];
  CotrollerCustomers cotrollerCategorias = CotrollerCustomers();
  ...
  inicializacion() async {
    enEspera = true;
    setState(() {});
    listaCategorias = await cotrollerCategorias.listarCustomers();
    enEspera = false;
    setState(() {});
  }
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    _registerAndUpdate(
                        ...
                        esRegistro: true,
                        categoriesActualizacion: CustomersRequest());
                  },
                ),
              ),
            )),
  ...
  Widget _botonEliminarCategoria(
      BuildContext context, CustomersRequest categoriesRequest) {
    return Material(
      elevation: 5,
  ...
  _registerAndUpdate(
      ...
      required CustomersRequest categoriesActualizacion}) {
    CustomersRequest categoriesRegistro = CustomersRequest();
    AwesomeDialog(
        context: context,
